...
USART1 usart1_enable( uint32_t baud, unsigned int FDbits, unsigned int Stopbits, unsigned int Parity )
{
	...
	// registers
	atmega128_usart1.ucsr1a =  ((_UCSR1A_TypeDef*) 0xC8);
	atmega128_usart1.ucsr1b =  ((_UCSR1B_TypeDef*) 0xC9);
	atmega128_usart1.ucsr1c =  ((_UCSR1C_TypeDef*) 0xCA);
	atmega128_usart1.ubrr1 = ((_uint16_t* ) 0x00CC);
	atmega128_usart1.udr1 = ((_uint8_t*) 0x00CE);
	// Vtable
